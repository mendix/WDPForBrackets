                    ...
                    $(item).on('click', function(){
                        ...
                        GitHubDomain.exec('getUserRepoReleases', 'mendix', repoName).done(function (body) {
                            ...
                            for (i = 0; i < body.length; i++) {
                                htmlReleases.append('<li class="mx-repo-release" data-repo-release-url="' + body[i].zipball_url + '">' + repoName + ' - ' + body[i].name + '<input type="file" nwdirectory /></li>');
                            }
                            ...
                            html.find('.mx-repo-release').each( function(index, item) { 
