...
define(function (require, exports, module) {
    ...
    var MODULE_NAME                     = 'mendix.wdpforbrackets',
        ...
        MendixSQLite = new NodeDomain("MendixSQLite", ExtensionUtils.getModulePath(module, "../node/MendixSQLite"));
    ...
    var MendixWorkspaceManager = {
        ...
        startMendix : function () {
            ...
            var source = ProjectManager.getProjectRoot()._path,
                ...
                database = source.split('src').join('data.db');
            
            database = database.split('data.db/').join('data.db');
            ...
            if (source.indexOf('/src') === -1) {
                ...
                // Create a database!
                MendixSQLite.exec('createDB', '"' + database + '"');
