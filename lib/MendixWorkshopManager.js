...
define(function (require, exports, module) {
    ...
    var MODULE_NAME                     = 'mendix.codesnippets',
        MODULE_NAME_STARTUP             = 'mendix.codesnippets.startup',
        MODULE_NAME_STARTUP_DIRECT      = 'mendix.codesnippets.startup.direct',
        ...
        MPKArchiverDomain = new NodeDomain("MPKArchiver", ExtensionUtils.getModulePath(module, "../node/MPKArchiver"));
    ...
    var MendixWorkshopManager = {
        ...
        buildCustomWidget : function (event) {
            var self = event.data.self,
                source = ProjectManager.getProjectRoot()._path,
            ...
            packageXML.done(function (xml) {
                ...
                MPKArchiverDomain.exec('createMPK', clientModuleName, source, destination).done(function (body) {
                    Dialogs.showModalDialog(
                        Dialogs.DIALOG_BTN_CANCEL,
                        "Information",
                        "You have successfully created a new MPK with the name '" + MendixWorkshopManager.clientModuleName + ".mpk'"
                    ).done(function (id) {
                    });
                });
            });
