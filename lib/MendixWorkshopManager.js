        ...
        buildCustomWidget : function (event) {
            ...
            if (source.indexOf('/src') === -1){
                ...
                packageXML.done(function (xml) {
                    ...
                    var result = MPKArchiverDomain.exec('createMPK', clientModuleName, source, destination)
                ...
                packageXML.fail(function(e){
                    ToastrManager.error("There is no package.xml avaliable within the source directory.");
                });
